    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            const attemptFetch = async () => {
                try {
                    ...
                    if (!trimmedText.startsWith('{') && !trimmedText.startsWith('[')) {
                        console.warn(`Attempt ${retryCount + 1}: Received HTML instead of JSON`);
            ...
            if (retryCount >= maxRetries) {
                ...
                setData({
                    footerLinks: [
                        { id: 1, name: "Undergraduate Programs", url: "/undergraduate-programs" },
                        { id: 2, name: "Postgraduate Programs", url: "/postgraduate-programs" },
                    ...
                    <div className="ed-footer__widget ed-footer__about">
                      <a href={asset_url} className="ed-footer__logo">
                        <Image
                          ...
                          alt={
                            data.footerLogo?.alternativeText ||
                            "University Logo"
                          }
                      ...
                      <p className="ed-footer__about-text">
                        ...
                        personal growth. Join a thriving community of learners
                        and innovators.
                      </p>
                      <ul className="ed-footer__about-social">
                        <li>
                  ...
                  <div className="col-lg-3 col-md-6 col-12">
                    <div className="ed-footer__widget contact-widget">
                      ...
                      <div className="ed-footer__contact">
                        ...
                        <div className="ed-footer__contact-info">
                          <span>Email</span>
                          <a href="mailto:info@applymbbs.in">
                            info@applymbbs.in
                          </a>
                        </div>
                      </div>
